		...
		<view class="ruleWrap">
				...
				<view class="money">
					<view class="left">
						<view class="item">
							...
							<text class='txt2' style="display: block">雷猫积分</text>
						</view>
					</view>
					<view class="right">
						<view class="item">
			...
			<view class="ruleNum">
				<view class="item" style="display: flex;align-items: center;">
					...
					<text class='txt2'>雷猫商城全部成交金额的1%会注入奖池</text>
				</view>
				<view class="item" style="display: flex;align-items: center;">
					<text class='txt1' style="display: inline-block;">2</text>
					<text class='txt2'>雷猫商城合伙人有权参与奖池瓜分</text>
				</view>
				<view class="item" style="display: flex;align-items: center;">
			...
			<view class="wrap">
				<view class="table">
					<view class="title">
						...
						<text class='txt txt4'>预计瓜分雷猫积分</text>
					</view>
