<template>
	<view class="account">
		<view class="box">
			<QSTabs :current="current_2" :tabs="tabs_2" width="375" activeColor="#42A2EC" @change="change($event, '1')" />
		</view>
		<!-- 钱包地址 -->
		<view class="address" v-if="current_2===0">
			...
			<view class="BTNWarp">
				<text class="btn" @click="toPage()">添加新的BTC地址</text>
			</view>
		</view>
		
		<!-- 收货地址 -->
		<view class="consignee" v-if="current_2===1">
					...
					<radio-group @change="radioChange2">
						<label class="uni-list-cell uni-list-cell-pd" v-for="(item,index) in underLine_address" :key='index' style="display: flex;">
							<view style="display: inline-block;">
								<radio :value="item.mobile" :checked="index === underLine_index" />
							</view>
							<view class="wrap">
			...
			<view style="height:100upx;width: 750upx;"></view>
			<view class="BTNWarp" style="left: 0;">
				<text class="btn" @click="toPage2()">添加新收货地址</text>
			</view>
