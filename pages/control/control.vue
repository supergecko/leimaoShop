<template>
	<view style="background: rgb(245,245,245);">
		...
		<view class="controlHeader">
			<view class="controlHeaderTX1">BTC挖矿</view>
			...
			<view class="controlHeaderSecond">
				<span style="width:362upx;display: inline-block;">{{hashrate_balance.hashrate}}<span class="controlHeaderSecondText">TH/S</span> </span>
				<span>{{hashrate_balance.balance}}<span class="controlHeaderSecondText">BTC</span> </span>
			</view>
			...
			<view class="controlMiddleWarp">
				...
				<view class="MiddleItemContent" v-for="(item,index) in day_balance" :key='index'>
					<view class="middleItemContentItem">
						<span class="contentLeft">{{item.balance}} BTC</span>
						<span class="contentRight">{{item.create_day}}</span>
					</view>
				</view>
			</view>
		</view>
